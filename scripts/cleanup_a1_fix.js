...
const dir = path.join(__dirname, '..', 'data', 'a1-vocab');
...
for (const file of files) {
    ...
    for (let line of lines) {
        ...
        if (parts.length >= 4) { 
            ...
            let pinyin = parts[2] ? parts[2].trim() : '';

            if (Object.prototype.hasOwnProperty.call(cleanupMap, word) && cleanupMap[word]) {
                ...
                // Replace remaining weird variants
                if (word === '喂(ㄨㄟˊ)') word = '喂';
